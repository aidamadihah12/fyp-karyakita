...
@section('content')
<div class="container">
    <h2 class="mb-4">Booking Details: #{{ $booking->id }}</h2>
...
<div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" value="{{ $booking->event_date ? \Carbon\Carbon::parse($booking->event_date)->format('Y-m-d') : '-' }}" disabled>
    </div>
    ...
    <div class="mb-3">
        ...
        @if ($booking->photographer)
            <input type="text" class="form-control"
                value="{{ $booking->photographer->name }} ({{ ucfirst($booking->photographer->user_role) }})" disabled>
        @else
